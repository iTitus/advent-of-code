...
public final class Day14 implements AocSolution {
    ...
    public void executeTests() {
        ...
        testWithInputPart1("2", BigIntegerMath.of(13312),
                "157 ORE => 5 NZVS",
                "165 ORE => 6 DCFZ",
        ...
        testWithInputPart1("3", BigIntegerMath.of(180697),
        ...
        testWithInputPart1("4", BigIntegerMath.of(2210736),
                "171 ORE => 8 CNZTR",
        ...
        testWithInputPart2("2", BigIntegerMath.of(82892753),
                "157 ORE => 5 NZVS",
                "165 ORE => 6 DCFZ",
                "44 XJWVT, 5 KHKGT, 1 QDVJ, 29 NZVS, 9 GPVTF, 48 HKGWZ => 1 FUEL",
                "12 HKGWZ, 1 GPVTF, 8 PSHF => 9 QDVJ",
        ...
        testWithInputPart2("3", BigIntegerMath.of(5586022),
                "2 VPVL, 7 FWMGM, 2 CXFTF, 11 MNCFX => 1 STKFG",
                "17 NVRVD, 3 JNWZP => 8 VPVL",
                "53 STKFG, 6 MNCFX, 46 VJHF, 81 HVMC, 68 CXFTF, 25 GNMV => 1 FUEL",
                "22 VJHF, 37 MNCFX => 5 FWMGM",
        ...
        testWithInputPart2("4", BigIntegerMath.of(460664),
                "171 ORE => 8 CNZTR",
                "7 ZLQW, 3 BMBT, 9 XCVML, 26 XMNCP, 1 WPTQ, 2 MZWV, 1 RJRHP => 4 PLWSL",
                "114 ORE => 4 BHXH",
                "14 VRPVC => 6 BMBT",
